...
const connectionOptions = {
  ...
  browser: ['Glitch-md 𓆩✮͢ꪑꪖꪖꫝỉꪹ_404⃤𓆪','Edge','1.8.0']
}
...
setInterval(async () => {
	...
	console.log(chalk.green(`╭━━━━━〔 GLITCH - MD 〕━━━━━⬣
┃ AUTO CLEAR | TEMP FILE CLEARED
╰━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━⬣`))
}, 60000) //1 munto
...
global.reloadHandler = async function (restatConn) {
  ...
  conn.welcome = '*_Hey_* @user\n*Welcome to* @group\n\n*_Please Introduce Yourself 🫵_*\n\n*Well I am Glitch-md WhatsApp Bot*\n\n*💠Group description🔮*\n@desc'
  conn.bye = '*GOODBYE👋* @user\n*Hope we will meet another time*'
  conn.spromote = '@user promoted to admin'
  conn.sdemote = '@user degraded'
...
_quickTest()
  .then(() => conn.logger.info('𓆩✮͢ꪑꪖꪖꫝỉꪹ_404⃤𓆪'))
  .catch(console.error)
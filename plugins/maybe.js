...
let nombre = '𝘿𝙀𝙀𝙋𝘼𝙆 𝙇𝙊𝙑𝙀 𝙂𝙇𝙄𝙏𝘾𝙃-𝙈𝘿 ❤️'
let nombre2 = '𝘿𝙀𝙀𝙋𝘼𝙆 𝙎𝙃𝘼𝙍𝙈𝘼💖' 
...
await delay(1 * 1000)
let wm = '𝘿𝙀𝙀𝙋𝘼𝙆 𝙇𝙊𝙑𝙀 𝙂𝙇𝙄𝙏𝘾𝙃-𝙈𝘿 ❤️'
let nn = 'deepak'
let imagen1 = 'null'
if (stiker) conn.sendFile(m.chat, stiker, 'sticker.webp', '',m, true, { contextInfo: { 'forwardingScore': 200, 'isForwarded': false, externalAdReply:{ showAdAttribution: true, title: wm, body: `𝘿𝙀𝙀𝙋𝘼𝙆 𝙎𝙃𝘼𝙍𝙈𝘼`, mediaType: 2, sourceUrl: nn, thumbnail: imagen1}}}, { quoted: m })
}
handler.customPrefix = /lindo|linda|pyar|love|baby|bonita|shizo/i 
